...
for lat, lon, pm in point_coords:
    ...
    img_data = pm.find('.//kml:ExtendedData/kml:Data[@name="Image"]/kml:value', namespaces=NS)
    if img_data is not None:
        ax.text(x, y + 15, os.path.basename(img_data.text), fontsize=6, ha='center', color='gray')
